...
?>
	...
	<head>
		<title>Ujian Online -- UAS Interpro</title>
	...
	<body onLoad="document.postform.elements['username'].focus();">
		<div id="outer">
			...
			<div id="body-middle" class="clearfix">
				...
				<div id="main-col">
					...
					<div id="nameplate-middle" class="clearfix">
						<h2><font color="#333333"><b><marquee behavior="scroll" scrollamount="5">Selamat Datang di Ujian Online </marquee></b></font></h2>
					</div>
			...
			<!-- Footer -->
			<div id="footer">
				<p><a href=""><font color="#666666">Web</font></a></p>
		  </div>
